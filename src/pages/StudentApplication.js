...
export default function StudentApplication() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const printField = (label, value, header, bold=false) => {
                if (header) {
                    doc.setFont("helvetica", "bold");
                    doc.setFontSize(18);
                    doc.text(label, 18, y);
                ...
                const splitText = doc.splitTextToSize(displayValue, 150);
            ...
            //doc.save("student-application.pdf");
